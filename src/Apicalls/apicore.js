...
//top is the attendance api
export const attendance = async (start, stop) => {
  try {
    const response = await fetch(
      `http://attendance.nodewire.org/attendance?start=${start}&stop=${stop}`,
      {
        method: "GET",
      }
    );
...
export const getLeave = async (page) => {
  ...
  try {
    let fetchleave = await fetch(
      `${LEAVEAPI}/myleave/${user.staffregnumber}?page=${page}`,
      {
        method: "POST",
        headers: {
          Accept: "application/json",
...
export const getdepartmentLeave = async (page) => {
  ...
  try {
    let fetchleaves = await fetch(
      `${LEAVEAPI}/departmentleave/${user.staffregnumber}?page=${page}`,
      {
        method: "POST",
        headers: {
          Accept: "application/json",
