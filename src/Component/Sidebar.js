  ...
  return (
    <div id="sidebar">
      ...
      <div className="sidebar__menu">
        <div
          className={
            isActive(history, "/hrsystem/hrdashboard")
        ...
        <div
          className={
            isActive(history, "/hrsystem/profile")
              ? "sidebar__link active_menu_link"
              : "sidebar__link"
          }
        >
        ...
        <div
          style={isHr() ? { display: "block" } : { display: "none" }}
          className={
        ...
        <div
          style={isHr() ? { display: "block" } : { display: "none" }}
          className={
            isActive(history, "/hrsystem/addemployee")
              ? "sidebar__link active_menu_link"
              : "sidebar__link"
          }
        >
        ...
        <div
          style={isHr() ? { display: "block" } : { display: "none" }}
          className={
            isActive(history, "/hrsystem/leaveapplications")
              ? "sidebar__link active_menu_link"
              : "sidebar__link"
          }
        >
          <i className="fas fa-business-time"></i>
          <Link to="/hrsystem/leaveapplications">
            Manage Leave Applications
          </Link>
        </div>
        <div
          className={
            isActive(history, "/hrsystem/leaveapply")
              ? "sidebar__link active_menu_link"
              : "sidebar__link"
          }
        >
        ...
        <div
          style={isUnitHead() ? { display: "block" } : { display: "none" }}
          className={
            isActive(history, "/hrsystem/lineapply")
              ? "sidebar__link active_menu_link"
              : "sidebar__link"
          }
        >
        ...
        <div
          style={isHr() ? { display: "block" } : { display: "none" }}
          className={
            isActive(history, "/hrsystem/checkresult")
              ? "sidebar__link active_menu_link"
              : "sidebar__link"
          }
        >
        ...
        <div
          className={
            isActive(history, "/hrsystem/appraisal")
              ? "sidebar__link active_menu_link"
              : "sidebar__link"
          }
        >
